...
//    _LCD_C_MAIN_1_AMPERAGE_WARNING,
    ...
    _LCD_C_MAIN_1_PRESSURE_3,
    _LCD_C_MAIN_1_PRESSURE_4,
...
typedef enum
{
    ...
    _LCD_C_SETTING_OPTION_PRESSURE_P1,
    _LCD_C_SETTING_OPTION_PRESSURE_P2,
    _LCD_C_SETTING_OPTION_PRESSURE_P3,
    _LCD_C_SETTING_OPTION_PRESSURE_P4,
