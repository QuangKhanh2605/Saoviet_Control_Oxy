...
{
  {_LCD_C_MAIN_1_STATE_AMPERAGE,        0,0,0,1,        (char*)"A:"},
  {_LCD_C_MAIN_1_STATE_AMPERAGE_OK,     0,0,2,5,        (char*)"OK  "},
  {_LCD_C_MAIN_1_STATE_AMPERAGE_FAIL,   0,0,2,5,        (char*)"FAIL"},
  
  {_LCD_C_MAIN_1_STATE_PRESSURE,        0,0,7,8,        (char*)"P:"},
  {_LCD_C_MAIN_1_STATE_PRESSURE_OK,     0,0,9,12,       (char*)"OK  "},
  {_LCD_C_MAIN_1_STATE_PRESSURE_FAIL,   0,0,9,12,       (char*)"FAIL"},
  
  {_LCD_C_MAIN_1_STATE_MACHINE_OFF,     0,0,13,15,      (char*)"OF"},
  {_LCD_C_MAIN_1_STATE_MACHINE_MAN,     0,0,13,15,      (char*)" M"},
  {_LCD_C_MAIN_1_STATE_MACHINE_AUTO,    0,0,13,15,      (char*)" A"},
  
  {_LCD_C_MAIN_1_COL_1,                 0,1,8,8,        (char*)"|"},
  {_LCD_C_MAIN_1_COL_2,                 0,2,8,8,        (char*)"|"},
  {_LCD_C_MAIN_1_COL_3,                 0,3,8,8,        (char*)"|"},
//  {_LCD_C_MAIN_1_COL_4,             0,3,8,8,        (char*)"|"},
  
  {_LCD_C_MAIN_1_AMPERAGE_1,            0,1,0,2,        (char*)"I1:"},
  {_LCD_C_MAIN_1_AMPERAGE_2,            0,2,0,2,        (char*)"I2:"},
  {_LCD_C_MAIN_1_AMPERAGE_3,            0,3,0,2,        (char*)"I3:"},
//  {_LCD_C_MAIN_1_AMPERAGE_UNIT,     0,3,7,7,        (char*)"A"},
//  {_LCD_C_MAIN_1_AMPERAGE_OK,       0,3,0,3,        (char*)"OK  "},
//  {_LCD_C_MAIN_1_AMPERAGE_WARNING,  0,3,0,3,        (char*)"FAIL"},
  
  {_LCD_C_MAIN_1_PRESSURE_1,            0,2,9,11,       (char*)"P1:"},
  {_LCD_C_MAIN_1_PRESSURE_2,            0,2,9,11,       (char*)"P2:"},
  {_LCD_C_MAIN_1_PRESSURE_3,            0,2,9,11,       (char*)"P3:"},
  {_LCD_C_MAIN_1_PRESSURE_4,            0,2,9,11,       (char*)"P4:"},
  {_LCD_C_MAIN_1_PRESSURE_UNIT,         0,3,13,15,      (char*)"Bar"},
//  {_LCD_C_MAIN_1_PRESSURE_OK,       0,3,9,12,       (char*)"OK  "},
//  {_LCD_C_MAIN_1_PRESSURE_WARNING,  0,3,9,12,       (char*)"FAIL"},
};

LCD_Uint_Display                    oLCD_U_Main_1[]=
{
  {_LCD_U_MAIN_1_AMPERAGE_1,        0,1,4,7,         &sMeasureMotor.AmperagePhase_1},
  {_LCD_U_MAIN_1_AMPERAGE_2,        0,2,4,7,         &sMeasureMotor.AmperagePhase_2},
  {_LCD_U_MAIN_1_AMPERAGE_3,        0,3,4,7,         &sMeasureMotor.AmperagePhase_3},
  {_LCD_U_MAIN_1_PRESSURE,          0,2,12,15,       &sMeasureMotor.Pressure_P1},
};
...
LCD_Char_Display                    oLCD_C_Setting_Option[]=
{
  ...
  {_LCD_C_SETTING_OPTION_AMPERAGE,      0,1,1,8,             (char*)"Amperage"},
  {_LCD_C_SETTING_OPTION_AMPERAGE_ON,   0,1,12,14,           (char*)"ON"},
  {_LCD_C_SETTING_OPTION_AMPERAGE_OFF,  0,1,12,14,           (char*)"OFF"},
  
  {_LCD_C_SETTING_OPTION_PRESSURE,      0,2,1,8,             (char*)"Pressure"},
  {_LCD_C_SETTING_OPTION_PRESSURE_P1,   0,2,12,14,           (char*)"P1"},
  {_LCD_C_SETTING_OPTION_PRESSURE_P2,   0,2,12,14,           (char*)"P2"},
  {_LCD_C_SETTING_OPTION_PRESSURE_P3,   0,2,12,14,           (char*)"P3"},
  {_LCD_C_SETTING_OPTION_PRESSURE_P4,   0,2,12,14,           (char*)"P4"},
  {_LCD_C_SETTING_OPTION_PRESSURE_OFF,  0,2,12,14,           (char*)"OFF"},
};
    ...
    for(uint8_t i = 0; i < _LCD_U_MAIN_1_END; i++)
    {
        if(oLCD_U_Main_1[i].Status == 1)
        {
            LCD_Display_Uint_Point(&LCD, oLCD_U_Main_1[i].Rol, oLCD_U_Main_1[i].Col_Begin, oLCD_U_Main_1[i].Col_End,
                                    ALIGN_RIGHT, (int)(*oLCD_U_Main_1[i].Object), 1);
...
//    oLCD_C_Setting_Option[_LCD_C_SETTING_OPTION].Status = 1;
    ...
    switch(sMenuStamp.Pressure_Option)
    {
        case _PRESSURE_OPTION_P1:
          oLCD_C_Setting_Option[_LCD_C_SETTING_OPTION_PRESSURE_P1].Status = 1;
          break;
          
        case _PRESSURE_OPTION_P2:
          oLCD_C_Setting_Option[_LCD_C_SETTING_OPTION_PRESSURE_P2].Status = 1;
          break;
          
        case _PRESSURE_OPTION_P3:
          oLCD_C_Setting_Option[_LCD_C_SETTING_OPTION_PRESSURE_P3].Status = 1;
          break;
          
        case _PRESSURE_OPTION_P4:
          oLCD_C_Setting_Option[_LCD_C_SETTING_OPTION_PRESSURE_P4].Status = 1;
          break;
...
void        DLCD_Main_1_Entry(void)
{
    ...
    oLCD_C_Main_1[_LCD_C_MAIN_1_COL_1].Status = 1;
    oLCD_C_Main_1[_LCD_C_MAIN_1_COL_2].Status = 1;
    oLCD_C_Main_1[_LCD_C_MAIN_1_COL_3].Status = 1;
    
    oLCD_C_Main_1[_LCD_C_MAIN_1_AMPERAGE_1].Status = 1;
    oLCD_C_Main_1[_LCD_C_MAIN_1_AMPERAGE_2].Status = 1;
    oLCD_C_Main_1[_LCD_C_MAIN_1_AMPERAGE_3].Status = 1;
    ...
    switch(sParamMotor.Pressure_Option)
    {
        ...
        case _PRESSURE_OPTION_P1:
          ...
          oLCD_U_Main_1[_LCD_U_MAIN_1_PRESSURE].Object = &sMeasureMotor.Pressure_P1;
          break;
          
        case _PRESSURE_OPTION_P2:
          oLCD_C_Main_1[_LCD_C_MAIN_1_PRESSURE_2].Status = 1;
          oLCD_U_Main_1[_LCD_U_MAIN_1_PRESSURE].Object = &sMeasureMotor.Pressure_P2;
          break;
          
        case _PRESSURE_OPTION_P3:
          oLCD_C_Main_1[_LCD_C_MAIN_1_PRESSURE_3].Status = 1;
          oLCD_U_Main_1[_LCD_U_MAIN_1_PRESSURE].Object = &sMeasureMotor.Pressure_P3;
          break;
          
        case _PRESSURE_OPTION_P4:
          oLCD_C_Main_1[_LCD_C_MAIN_1_PRESSURE_4].Status = 1;
          oLCD_U_Main_1[_LCD_U_MAIN_1_PRESSURE].Object = &sMeasureMotor.Pressure_P4;
          break;
...
void DLCD_Main_1_Alter(void)
{
    ...
    static uint8_t stampOptionPressure = 0; 
    ...
    if(stampOptionPressure != sParamMotor.Pressure_Option)
    {
        stampOptionPressure = sParamMotor.Pressure_Option;
