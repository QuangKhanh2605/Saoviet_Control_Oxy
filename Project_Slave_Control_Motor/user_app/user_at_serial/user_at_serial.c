...
void        _fSET_OPTION_AMPERAGE (sData *str_Receiv, uint16_t Pos)
{
    ...
    if( str_Receiv->Data_a8[0] >= '0' && str_Receiv->Data_a8[0] <= '9')
    {
        ...
        {
            Save_OptionWarning(TempU32, sParamMotor.Pressure_Option);
            DCU_Respond(PortConfig, (uint8_t*)"OK", 2, 0);
        }
        else
            DCU_Respond(PortConfig, (uint8_t*)"ERROR", 5, 0);
...
void        _fGET_OPTION_PRESSURE (sData *str_Receiv, uint16_t Pos)
{
    ...
    switch(sParamMotor.Pressure_Option)
    {
        ...
        case _PRESSURE_OPTION_P1:
          DCU_Respond(PortConfig, (uint8_t*)"PRESSURE_OPTION_P1", 18, 0);
          break;
          
        case _PRESSURE_OPTION_P2:
          DCU_Respond(PortConfig, (uint8_t*)"PRESSURE_OPTION_P2", 18, 0);
          break;
          
        case _PRESSURE_OPTION_P3:
          DCU_Respond(PortConfig, (uint8_t*)"PRESSURE_OPTION_P3", 18, 0);
          break;
          
        case _PRESSURE_OPTION_P4:
          DCU_Respond(PortConfig, (uint8_t*)"PRESSURE_OPTION_P4", 18, 0);
          break;
...
void        _fSET_OPTION_PRESSURE (sData *str_Receiv, uint16_t Pos)
{
    ...
    if( str_Receiv->Data_a8[0] >= '0' && str_Receiv->Data_a8[0] <= '9')
    {
        ...
        TempU32 = Convert_String_To_Dec(str_Receiv->Data_a8 , length);
        if(TempU32 <= _PRESSURE_OPTION_P2)
        {
            Save_OptionWarning(sParamMotor.Amperage_Option, TempU32);
            DCU_Respond(PortConfig, (uint8_t*)"OK", 2, 0);
        }
        else
        {
