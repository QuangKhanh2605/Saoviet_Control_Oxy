...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, SIM_ON_OFF_Pin|MCU_RL2_Pin|MCU_RL3_Pin|MCU_LCD_RS_Pin
                          |MCU_LCD_RW_Pin|MCU_LCD_EN_Pin|MCU_LCD_D0_Pin|MCU_LCD_D4_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = SIM_ON_OFF_Pin|MCU_RL2_Pin|MCU_RL3_Pin|MCU_LCD_RS_Pin
                          |MCU_LCD_RW_Pin|MCU_LCD_EN_Pin|MCU_LCD_D0_Pin|MCU_LCD_D4_Pin;
