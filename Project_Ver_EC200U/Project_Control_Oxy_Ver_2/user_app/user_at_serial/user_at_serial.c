...
//			id ENUM				  kind process			     str Received
        ...
        {_GET_LOG_OXY_EEPROM,   fGET_LOG_OXY_EEPROM,        {(uint8_t*)"at+oxylog?",10}},
...
void        fGET_LOG_OXY_EEPROM (sData *str_Receiv, uint16_t Pos)
{
#ifdef USING_APP_OXYGEN
    fevent_active(sEventAppCtrlOxy, _EVENT_SEND_LOG_EEPROM);
    sOxyLogEEPROM.KindSendLog = PortConfig;
#endif
}
