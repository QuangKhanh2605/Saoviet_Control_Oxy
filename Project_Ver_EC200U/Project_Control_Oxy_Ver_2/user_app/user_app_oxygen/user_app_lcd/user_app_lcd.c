...
{
  {_LCD_C_MAIN_2_OXY_UPPER,         0,2,8,          (char*)"Oxy Up  :      mg/L "},
  {_LCD_C_MAIN_2_OXY_LOWER,         0,3,8,          (char*)"Oxy Low :      mg/L "},
  {_LCD_C_MAIN_2_SALINITY,          0,4,8,          (char*)"Salinity:      ppt  "},
  {_LCD_C_MAIN_2_OXY_UPPER_WARNING, 0,5,8,          (char*)"Upper Wa:      mg/L "},
  {_LCD_C_MAIN_2_OXY_LOWER_WARNING, 0,6,8,          (char*)"Lower Wa:      mg/L "},
  {_LCD_C_MAIN_2_TIME_DELAY,        0,7,8,          (char*)"Delay   :      Min  "},
};

LCD_Uint_Display                    oLCD_U_Main_2[]=
{
  {_LCD_U_MAIN_2_OXY_UPPER,         0,2,63,          &sParamCtrlOxy.Oxy_Upper},
  {_LCD_U_MAIN_2_OXY_LOWER,         0,3,63,          &sParamCtrlOxy.Oxy_Lower},
  {_LCD_U_MAIN_2_SALINITY,          0,4,63,          &sParamMeasure.Salinity},
  {_LCD_U_MAIN_2_OXY_UPPER_WARNING, 0,5,63,          &sParamCtrlOxy.Oxy_Upper_Warning},
  {_LCD_U_MAIN_2_OXY_LOWER_WARNING, 0,6,63,          &sParamCtrlOxy.Oxy_Lower_Warning},
  {_LCD_U_MAIN_2_TIME_DELAY,        0,7,63,          &sParamCtrlOxy.TimeDelay},
};
...
LCD_Char_Display                    oLCD_C_Setting_Parameter[]=
{
  ...
  {_LCD_C_SETTING_PARAMETER_OXY_UPPER_W, 0,6,8,             (char*)"[4] Up_W :     mg/L"},
  {_LCD_C_SETTING_PARAMETER_OXY_LOWER_W, 0,7,8,             (char*)"[5] Low_W:     mg/L"},
};
...
LCD_Uint_Display                    oLCD_U_Setting_Parameter[]=
{
  ...
  {_LCD_U_SETTING_PARAMETER_OXY_UPPER_W,0,6,67,              &sMenuStamp.OxyUpperWarning},
  {_LCD_U_SETTING_PARAMETER_OXY_LOWER_W,0,7,67,              &sMenuStamp.OxyLowerWarning},
};
...
void        DLCD_Setting_Parameter(void)
{
    ...
    for(uint8_t i = 0; i < _LCD_U_SETTING_PARAMETER_END; i++)
    {
        ...
        {
           if(i == _LCD_U_SETTING_PARAMETER_TIME_DELAY)
           {
