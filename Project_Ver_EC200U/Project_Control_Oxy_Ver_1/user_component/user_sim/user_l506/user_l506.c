...
const sCommand_Sim_Struct aSimL506Step[] =
{
   ...
   //SMS
    ...
    //HTTPS
    {   _SIM_HTTPS_ACQUIRE,     at_callback_success,        at_callback_failure,            "OK",               "AT+CHTTPSSTART\r"  },
    {   _SIM_HTTPS_STOP,        at_callback_success,        at_callback_failure,            "OK",               "AT+CHTTPSSTOP\r"   },
    
    {   _SIM_HTTPS_OPEN_SES_1,  _CbHTTPS_OPEN_SES_1,        at_callback_failure,            NULL,               "AT+CHTTPSOPSE="    },
    {   _SIM_HTTPS_OPEN_SES_2,  at_callback_success,        at_callback_failure,            "OK",               "\r"                },
    
    {   _SIM_HTTPS_CLOSE_SES,   at_callback_success,        at_callback_failure,            "OK",               "AT+CHTTPSCLSE\r"   },
    
    {   _SIM_HTTPS_SEND_1,      _CbHTTP_POST_LENGTH,        at_callback_failure,            "OK",               "AT+CHTTPSSEND="    },
    {   _SIM_HTTPS_SEND_2,      _CbHTTP_POST_DATA,          at_callback_failure,            ">>",               "\r"                },
    {   _SIM_HTTPS_SEND_3,      at_callback_success,        at_callback_failure,            "OK",               NULL,               },  //hoac ctrl+Z: 0x1A
    // HTTP	
