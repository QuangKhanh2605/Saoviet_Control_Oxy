...
#define AC_DETECT_PIN           HAL_GPIO_ReadPin(AC_DETECT_GPIO_Port, AC_DETECT_Pin)
                                //(HAL_GPIO_ReadPin(AC_DETECT_GPIO_Port, AC_DETECT_Pin) == GPIO_PIN_RESET) ? (true):(false)
#define RS485_POWER_OFF         HAL_GPIO_WritePin(RS485_ON_OFF_GPIO_Port, RS485_ON_OFF_Pin, GPIO_PIN_SET);
#define RS485_POWER_ON          HAL_GPIO_WritePin(RS485_ON_OFF_GPIO_Port, RS485_ON_OFF_Pin, GPIO_PIN_RESET);

#define SLAVE_ID_DEFAULT1       0x1A
#define SLAVE_ID_DEFAULT2       0x1B
...
typedef enum
{
    ...
    _EVENT_CHECK_MODE,
    _EVENT_CHECK_AC_POWER,
    _EVENT_TEMH_ALARM_DURA,
    _EVENT_MAGNETIC_WAKE,
...
typedef struct
{
    ...
    uint8_t             AcDetectPowerOff_u8;
    uint8_t             IRQMainPowerDetect_u8;
}STempHumiVariable;
