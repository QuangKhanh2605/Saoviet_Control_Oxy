...
typedef struct
{
    ...
    uint8_t StateSensorOxy_Before;  //Trang thai ket noi vs Sensor OXY truoc 
    uint8_t StatePower_Before;      //Trang thai nguon cap truoc 
    uint8_t StateOxyLower_Before;   //Trang thai canh bao Oxy thap truoc 
