...
typedef enum
{
    _LCD_C_MAIN_1_ID_SLAVE,
    _LCD_C_MAIN_1_STATE_CONTROL_OFF,
    _LCD_C_MAIN_1_STATE_CONTROL_ON,
    _LCD_C_MAIN_1_STATE_CONTROL_FAIL,
