...
#define OXY_UPPER_W_DEFAULT   1450
#define OXY_LOWER_W_DEFAULT   450
#define OXY_UPPER_W_MAX       3000
#define OXY_LOWER_W_MIN       300

#define OXY_UPPER_DEFAULT   750
#define OXY_LOWER_DEFAULT   700
#define OXY_UPPER_MAX       3000
#define OXY_LOWER_MIN       350
#define OXY_CYCLE_UP_LOW    10

#define SLAVE_485_TIME_MAX  999
#define SLAVE_485_TIME_MIN  2
...
#define SALINITY_DEFAULT    2500

#define TEMPERATURE_MAX     5000
#define TEMPERATURE_MIN     0

#define RUN_OXY_DEFAULT     66
#define FREE_OXY_DEFAULT    5

#define FREQ_SEND_NOTIFY    1

#define MAX_NUMBER_USER_SIM 5

#define TIME_RESEND_WARNING 30000

#define TIME_RESEND_WARNING_PUMP 1

#define TIME_RUN_OXY_SAFETY         10
#define TIME_SAMPLING_OXY_SAFETY    20

#define TIME_SAFETY_MAX             60
#define TIME_SAFETY_MIN             5
...
typedef enum
{
    _OXY_STT_OK,
    _OXY_STT_FAIL,
}eKindStateWarningOxy;

typedef enum
{
    _OXY_SAFETY_SAMPLING,
    _OXY_SAFETY_RUN,
}eKindStateOxySafety;
...
typedef struct
{
    ...
    uint8_t StateSafety;            //Trang thai dieu khien an toan 
    
    uint8_t StateWarningOxy_Connect;
    uint8_t StateWarningOxy_Measure;
    uint8_t StateWarningOxy_Pump;
}Struct_StateCtrlOxy;
...
typedef struct
{
    ...
    uint32_t Oxy_Safety_Run;
    uint32_t Oxy_Safety_Sampling;
}Struct_GettickMs;

typedef struct
{
    uint16_t TimeRun;
    uint16_t TimeSampling;
}Struct_TimeSafety;
...
extern Struct_TimeSafety                sTimeSafety;
/*================= Function Handle ================*/
