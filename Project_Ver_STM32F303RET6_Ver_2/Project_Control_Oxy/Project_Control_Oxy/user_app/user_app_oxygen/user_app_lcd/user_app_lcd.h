...
/*-------------------------Enum LCD Main 2 Tab 2---------------------*/
typedef enum
{
    _LCD_C_MAIN_2_TAB_2_PH_UPPER,
    _LCD_C_MAIN_2_TAB_2_PH_LOWER,
    
    _LCD_C_MAIN_2_TAB_2_END,
}eKindLcd_C_Main_2_Tab_2;

typedef enum
{
    _LCD_U_MAIN_2_TAB_2_PH_UPPER,
    _LCD_U_MAIN_2_TAB_2_PH_LOWER,
    
    _LCD_U_MAIN_2_TAB_2_END,
}eKindLcd_U_Main_2_Tab_2;

/*------------------------Enum LCD Main 3 ----------------------------*/
typedef enum
{
    _LCD_C_MAIN_3_TITLE,
    _LCD_C_MAIN_3_OXY_CONNECT,
    _LCD_C_MAIN_3_OXY_MEASURE,
    _LCD_C_MAIN_3_OXY_PUMP,
    _LCD_C_MAIN_3_PH_CONNECT,
    _LCD_C_MAIN_3_PH_MEASURE,
...
typedef enum
{
    ...
    _LCD_C_SETTING_CALIB_PH_POINT_686,
    _LCD_C_SETTING_CALIB_PH_POINT_918,
...
typedef enum
{
    ...
    _LCD_C_SETIING_CYCLE_NUMBER_MOTOR,
...
typedef enum
{
    _LCD_U_SETIING_CYCLE_NUMBER_MOTOR,
...
typedef enum
{
    ...
    _LCD_C_SETTING_PARAMETER_OXY_PLEASE,
    _LCD_C_SETTING_PARAMETER_OXY_SELECT,
...
/*----------------------------Enum setting parameter tab 2--------------------------*/
typedef enum
{
    _LCD_C_SETTING_PARAMETER_TAB_2_PH_UPPER,
    _LCD_C_SETTING_PARAMETER_TAB_2_PH_LOWER,
//    _LCD_C_SETTING_PARAMETER_TAB_2_TIME_DELAY,
    _LCD_C_SETTING_PARAMETER_TAB_2_PH_TIME_PUMP,
    _LCD_C_SETTING_PARAMETER_TAB_2_PH_TIME_SAMPLING,
    
    _LCD_C_SETTING_PARAMETER_TAB_2_END,
}eKindLcd_C_Setting_Parameter_Tab_2;

typedef enum
{
    _LCD_U_SETTING_PARAMETER_TAB_2_PH_UPPER,
    _LCD_U_SETTING_PARAMETER_TAB_2_PH_LOWER,
//    _LCD_U_SETTING_PARAMETER_TAB_2_TIME_DELAY,
    _LCD_U_SETTING_PARAMETER_TAB_2_PH_TIME_PUMP,
    _LCD_U_SETTING_PARAMETER_TAB_2_PH_TIME_SAMPLING,
    
    _LCD_U_SETTING_PARAMETER_TAB_2_END,
}eKindLcd_U_Setting_Parameter_Tab_2;
/*---------------------------Enum LCD Login------------------------*/
typedef enum
{
...
typedef enum
{
    ...
    _LCD_C_CALIB_PH_POINT_686,
    _LCD_C_CALIB_PH_POINT_918,
...
extern LCD_Char_Display                    oLCD_C_Main_2_Tab_2[];
extern LCD_Uint_Display                    oLCD_U_Main_2_Tab_2[];
...
extern LCD_Char_Display                    oLCD_C_Setting_Parameter_Tab_2[];
extern LCD_Uint_Display                    oLCD_U_Setting_Parameter_Tab_2[];
