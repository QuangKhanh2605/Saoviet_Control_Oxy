...
typedef enum
{
    ...
    _GET_PH_STEP_WARNING,
    _SET_PH_STEP_WARNING,
    
    _GET_PH_TIME_PUMP,
    _SET_PH_TIME_PUMP,
    
    _GET_PH_TIME_SAMPLING,
    _SET_PH_TIME_SAMPLING,
    
    _GET_PH_CHOOSE_OPTION,
    _SET_PH_CHOOSE_OPTION,
    ...
    _GET_TIME_RUN_SAFETY,
    _SET_TIME_RUN_SAFETY,
    
    _GET_TIME_SAMPLING_SAFETY,
    _SET_TIME_SAMPLING_SAFETY,
