...
//			id ENUM				  kind process			     str Received
		...
		{_SET_SERVER_MAIN,	 	_fSET_SERVER_MAIN_INFO,	    {(uint8_t*)"at+mqttmain=",12}},     //Ex: at+mqttmain=124.158.5.154,1883,syswmsv,sv@wmsv568
		{_QUERY_SERVER_MAIN, 	_fQUERY_SERVER_MAIN_INFO,	{(uint8_t*)"at+mqttmain?",12}},
        
        {_SET_SERVER_BACKUP,	_fSET_SERVER_BACKUP_INFO,	{(uint8_t*)"at+mqttbackup=",14}},   //Ex: at+mqttbackup=117.6.163.177,1883,syswmsv,sv@wmsv568
        ...
        {_SET_OXY_UPPER,        fSET_OXY_UPPER,             {(uint8_t*)"at+oxyupper=",12}},     //Ex: at+oxyupper=850
        
        {_GET_OXY_LOWER,        fGET_OXY_LOWER,             {(uint8_t*)"at+oxylower?",12}},
        {_SET_OXY_LOWER,        fSET_OXY_LOWER,             {(uint8_t*)"at+oxylower=",12}},     //Ex: at+oxylower=650
        
        {_GET_OXY_UPPER_W,      fGET_OXY_UPPER_W,           {(uint8_t*)"at+oxyupperwarning?",19}},
        {_SET_OXY_UPPER_W,      fSET_OXY_UPPER_W,           {(uint8_t*)"at+oxyupperwarning=",19}},     //Ex: at+oxyupper=850
        
        {_GET_OXY_LOWER_W,      fGET_OXY_LOWER_W,           {(uint8_t*)"at+oxylowerwarning?",19}},
        {_SET_OXY_LOWER_W,      fSET_OXY_LOWER_W,           {(uint8_t*)"at+oxylowerwarning=",19}},     //Ex: at+oxylower=650
      
        {_GET_SALINITY_SETUP,   fGET_SALINITY_SETUP,        {(uint8_t*)"at+salinity?",12}},            //Ex: at+salinity?
        {_SET_SALINITY_SETUP,   fSET_SALINITY_SETUP,        {(uint8_t*)"at+salinity=",12}},            //Ex: at+salinity=2000 (20 ppt)
        
        {_GET_PH_UPPER,         fGET_PH_UPPER,              {(uint8_t*)"at+phupper?",11}},
        {_SET_PH_UPPER,         fSET_PH_UPPER,              {(uint8_t*)"at+phupper=",11}},     //Ex: at+oxyupper=850
        
        {_GET_PH_LOWER,         fGET_PH_LOWER,              {(uint8_t*)"at+phlower?",11}},
        {_SET_PH_LOWER,         fSET_PH_LOWER,              {(uint8_t*)"at+phlower=",11}},     //Ex: at+oxylower=650
        
        {_GET_PH_STEP_WARNING,  fGET_PH_STEP_WARNING,       {(uint8_t*)"at+phwarning?",13}},        //"at+phwarning?"
        {_SET_PH_STEP_WARNING,  fSET_PH_STEP_WARNING,       {(uint8_t*)"at+phwarning=",13}},        //"at+phwarning=100" set step warning = 1.00 pH
        
        {_GET_PH_TIME_PUMP,     fGET_PH_TIME_PUMP,          {(uint8_t*)"at+phtimepump?",14}},       //"at+phtimepump?"
        {_SET_PH_TIME_PUMP,     fSET_PH_TIME_PUMP,          {(uint8_t*)"at+phtimepump=",14}},       //"at+phtimepump=5" set time pump 1 Min
        
        {_GET_PH_TIME_SAMPLING, fGET_PH_TIME_SAMPLING,      {(uint8_t*)"at+phtimesampling?",18}},   //"at+phtimesampling?"
        {_SET_PH_TIME_SAMPLING, fSET_PH_TIME_SAMPLING,      {(uint8_t*)"at+phtimesampling=",18}},   //"at+phtimesampling=15" set time sampling 15 Min
        
        {_GET_PH_CHOOSE_OPTION, fGET_PH_CHOOSE_OPTION,      {(uint8_t*)"at+phoption?",12}},         //"at+phoption?"
        {_SET_PH_CHOOSE_OPTION, fSET_PH_CHOOSE_OPTION,      {(uint8_t*)"at+phoption=",12}},         //"at+phoption=1" 0->Unusing, 1->Using
        
        {_GET_OXY_MEASURE,      fGET_OXY_MEASURE,           {(uint8_t*)"at+measurevalue?",16}},   //Gia tri do luong sensor
        ...
        {_SEND_MOTOR_FAIL,      fSEND_MOTOR_FAIL,           {(uint8_t*)"at+motor=fail",13}},
        
        {_GET_NUMBER_MOTOR,     fGET_NUMBER_MOTOR,          {(uint8_t*)"at+numbermotor?",15}},
        {_SET_NUMBER_MOTOR,     fSET_NUMBER_MOTOR,          {(uint8_t*)"at+numbermotor=",15}},
        
        {_GET_TIME_RUN_SAFETY,      fGET_TIME_RUN_SAFETY,       {(uint8_t*)"at+timerunsafety?",17}},
        {_SET_TIME_RUN_SAFETY,      fSET_TIME_RUN_SAFETY,       {(uint8_t*)"at+timerunsafety=",17}},
        
        {_GET_TIME_SAMPLING_SAFETY, fGET_TIME_SAMPLING_SAFETY,  {(uint8_t*)"at+timesamplingsafety?",22}},
        {_SET_TIME_SAMPLING_SAFETY, fSET_TIME_SAMPLING_SAFETY,  {(uint8_t*)"at+timesamplingsafety=",22}},
...
void        fSET_TIMECHANGE_OXY (sData *str_Receiv, uint16_t Pos)
{
    ...
    if( str_Receiv->Data_a8[0] >= '0' && str_Receiv->Data_a8[0] <= '9')
    {
        ...
        Save_TimeCtrlOxy(sParamCtrlOxy.TimeDelay, TempU32);
        DCU_Respond(PortConfig, (uint8_t*)"OK", 2, 0);
    }
    else
    {
...
void        fSET_TIMEDELAY_OXY (sData *str_Receiv, uint16_t Pos)
{
    ...
    if( str_Receiv->Data_a8[0] >= '0' && str_Receiv->Data_a8[0] <= '9')
    {
        ...
        {
            Save_TimeCtrlOxy(TempU32, sParamCtrlOxy.TimeChange);
            DCU_Respond(PortConfig, (uint8_t*)"OK", 2, 0);
        }
        else
        {
...
void        fSET_OXY_UPPER (sData *str_Receiv, uint16_t Pos)
{
    ...
    if( str_Receiv->Data_a8[0] >= '0' && str_Receiv->Data_a8[0] <= '9')
    {
        ...
        {
            Save_OxyUpperLower(TempU32, sParamCtrlOxy.Oxy_Lower, sParamCtrlOxy.Oxy_Upper_Warning, sParamCtrlOxy.Oxy_Lower_Warning);
...
void        fSET_OXY_LOWER (sData *str_Receiv, uint16_t Pos)
{
    ...
    if( str_Receiv->Data_a8[0] >= '0' && str_Receiv->Data_a8[0] <= '9')
    {
        ...
        {
            Save_OxyUpperLower(sParamCtrlOxy.Oxy_Upper, TempU32, sParamCtrlOxy.Oxy_Upper_Warning, sParamCtrlOxy.Oxy_Lower_Warning );
            DCU_Respond (PortConfig, (uint8_t *)"OK", 2, 1);
        }
        else
            DCU_Respond(PortConfig, (uint8_t *)"FAIL", 4, 0);
...
{
#ifdef USING_APP_OXYGEN
    uint8_t aTemp[20] = "Oxy_Upper_W:";   //11 ki tu dau tien
    uint16_t length = 12;

    Convert_Point_Int_To_String_Scale (aTemp, &length, (int)(sParamCtrlOxy.Oxy_Upper_Warning), 0xFE);
...
void        fSET_OXY_UPPER_W (sData *str_Receiv, uint16_t Pos)
{
    ...
    if( str_Receiv->Data_a8[0] >= '0' && str_Receiv->Data_a8[0] <= '9')
    {
        ...
        TempU32 = Convert_String_To_Dec(str_Receiv->Data_a8 , length);
        if(TempU32 > sParamCtrlOxy.Oxy_Lower && TempU32 <= OXY_UPPER_W_MAX)
        {
            Save_OxyUpperLower(sParamCtrlOxy.Oxy_Upper, sParamCtrlOxy.Oxy_Lower, TempU32, sParamCtrlOxy.Oxy_Lower_Warning);
            DCU_Respond (PortConfig, (uint8_t *)"OK", 2, 1);
        }
        else
            DCU_Respond(PortConfig, (uint8_t *)"FAIL", 4, 0);
...
{
#ifdef USING_APP_OXYGEN
    uint8_t aTemp[20] = "Oxy_Lower_W:";   //11 ki tu dau tien
    uint16_t length = 12;

    Convert_Point_Int_To_String_Scale (aTemp, &length, (int)(sParamCtrlOxy.Oxy_Lower_Warning), 0xFE);
...
void        fSET_OXY_LOWER_W (sData *str_Receiv, uint16_t Pos)
{
    ...
    if( str_Receiv->Data_a8[0] >= '0' && str_Receiv->Data_a8[0] <= '9')
    {
        ...
        TempU32 = Convert_String_To_Dec(str_Receiv->Data_a8 , length);
        if(TempU32 < sParamCtrlOxy.Oxy_Upper && TempU32 >= OXY_LOWER_W_MIN)
        {
            Save_OxyUpperLower(sParamCtrlOxy.Oxy_Upper, sParamCtrlOxy.Oxy_Lower, sParamCtrlOxy.Oxy_Upper_Warning, TempU32 );
            DCU_Respond (PortConfig, (uint8_t *)"OK", 2, 1);
        }
        else
            DCU_Respond(PortConfig, (uint8_t *)"FAIL", 4, 0);
...
void        fGET_SALINITY_SETUP (sData *str_Receiv, uint16_t Pos)
{
#ifdef USING_APP_OXYGEN
    uint8_t aTemp[20] = "Salinity:";   //11 ki tu dau tien
    uint16_t length = 9;
...
void        fSET_SALINITY_SETUP (sData *str_Receiv, uint16_t Pos)
{
#ifdef USING_APP_OXYGEN
    uint32_t TempU32 = 0;
    if( str_Receiv->Data_a8[0] >= '0' && str_Receiv->Data_a8[0] <= '9')
    {
        ...
        TempU32 = TempU32/100;
        TempU32 = TempU32*100;
        if(TempU32 <= SALINITY_MAX)
        {
            Save_Salinity(TempU32);
            DCU_Respond (PortConfig, (uint8_t *)"OK", 2, 1);
        }
        else
            DCU_Respond(PortConfig, (uint8_t *)"FAIL", 4, 0);
...
void        fGET_PH_UPPER (sData *str_Receiv, uint16_t Pos)
{
#ifdef USING_APP_OXYGEN
    uint8_t aTemp[20] = "pH_Upper:";   //11 ki tu dau tien
    uint16_t length = 9;

    Convert_Point_Int_To_String_Scale (aTemp, &length, (int)(sParamCtrlPH.pH_Upper), 0xFE);

	DCU_Respond(PortConfig, aTemp, length, 0);
#endif
}

void        fSET_PH_UPPER (sData *str_Receiv, uint16_t Pos)
{
#ifdef USING_APP_OXYGEN
    uint32_t TempU32 = 0;
    if( str_Receiv->Data_a8[0] >= '0' && str_Receiv->Data_a8[0] <= '9')
    {
        ...
        TempU32 = Convert_String_To_Dec(str_Receiv->Data_a8 , length);
        if(TempU32 > sParamCtrlPH.pH_Lower && TempU32 <= PH_UPPER_MAX)
        {
            Save_pH_UpperLowerWar(TempU32, sParamCtrlPH.pH_Lower, sParamCtrlPH.pH_StepWarning);
            DCU_Respond (PortConfig, (uint8_t *)"OK", 2, 1);
        }
        else
            DCU_Respond(PortConfig, (uint8_t *)"FAIL", 4, 0);
...
void        fGET_PH_LOWER (sData *str_Receiv, uint16_t Pos)
{
#ifdef USING_APP_OXYGEN
    uint8_t aTemp[20] = "pH_Lower:";   //11 ki tu dau tien
    uint16_t length = 9;

    Convert_Point_Int_To_String_Scale (aTemp, &length, (int)(sParamCtrlPH.pH_Lower), 0xFE);

	DCU_Respond(PortConfig, aTemp, length, 0);
#endif
}

void        fSET_PH_LOWER (sData *str_Receiv, uint16_t Pos)
{
#ifdef USING_APP_OXYGEN
    uint32_t TempU32 = 0;
    if( str_Receiv->Data_a8[0] >= '0' && str_Receiv->Data_a8[0] <= '9')
    {
        ...
        TempU32 = Convert_String_To_Dec(str_Receiv->Data_a8 , length);
        if(TempU32 < sParamCtrlPH.pH_Upper && TempU32 >= PH_LOWER_MIN)
        {
            Save_pH_UpperLowerWar(sParamCtrlPH.pH_Upper, TempU32, sParamCtrlPH.pH_StepWarning);
            DCU_Respond (PortConfig, (uint8_t *)"OK", 2, 1);
        }
        else
            DCU_Respond(PortConfig, (uint8_t *)"FAIL", 4, 0);
...
void        fGET_PH_STEP_WARNING (sData *str_Receiv, uint16_t Pos)
{
#ifdef USING_APP_OXYGEN
    uint8_t aTemp[20] = "pH_Warning:";   //11 ki tu dau tien
    uint16_t length = 11;

    Convert_Point_Int_To_String_Scale (aTemp, &length, (int)(sParamCtrlPH.pH_StepWarning), 0xFE);

	DCU_Respond(PortConfig, aTemp, length, 0);
#endif
}

void        fSET_PH_STEP_WARNING (sData *str_Receiv, uint16_t Pos)
{
#ifdef USING_APP_OXYGEN
    uint32_t TempU32 = 0;
    if( str_Receiv->Data_a8[0] >= '0' && str_Receiv->Data_a8[0] <= '9')
    {
        ...
        TempU32 = Convert_String_To_Dec(str_Receiv->Data_a8 , length);
        if(TempU32 <= PH_STEP_WARNING_MAX && TempU32 >= PH_STEP_WARNING_MIN)
        {
            Save_pH_UpperLowerWar(sParamCtrlPH.pH_Upper, sParamCtrlPH.pH_Lower, TempU32);
            DCU_Respond (PortConfig, (uint8_t *)"OK", 2, 1);
        }
        else
            DCU_Respond(PortConfig, (uint8_t *)"FAIL", 4, 0);
...
void        fGET_PH_TIME_PUMP (sData *str_Receiv, uint16_t Pos)
{
#ifdef USING_APP_OXYGEN
    uint8_t aTemp[20] = "pH_Time_Pump:";   //13 ki tu dau tien
    sData StrResp = {&aTemp[0], 13}; 

    Convert_Uint64_To_StringDec (&StrResp, (uint64_t) (sParamCtrlPH.pH_TimePump), 0);

	DCU_Respond(PortConfig, StrResp.Data_a8, StrResp.Length_u16, 0);
#endif
}

void        fSET_PH_TIME_PUMP (sData *str_Receiv, uint16_t Pos)
{
#ifdef USING_APP_OXYGEN
    uint32_t TempU32 = 0;
    if( str_Receiv->Data_a8[0] >= '0' && str_Receiv->Data_a8[0] <= '9')
    {
        ...
        TempU32 = Convert_String_To_Dec(str_Receiv->Data_a8 , length);
        if(TempU32 <=PH_TIME_CONTROL_MAX && TempU32 >=PH_TIME_CONTROL_MIN)
        {
            Save_pH_TimeControl(TempU32, sParamCtrlPH.pH_TimeSampling);
            DCU_Respond(PortConfig, (uint8_t*)"OK", 2, 0);
        }
        else
        {
...
void        fGET_PH_TIME_SAMPLING (sData *str_Receiv, uint16_t Pos)
{
#ifdef USING_APP_OXYGEN
    uint8_t aTemp[20] = "pH_Time_Samp:";   //13 ki tu dau tien
    sData StrResp = {&aTemp[0], 13}; 

    Convert_Uint64_To_StringDec (&StrResp, (uint64_t) (sParamCtrlPH.pH_TimeSampling), 0);

	DCU_Respond(PortConfig, StrResp.Data_a8, StrResp.Length_u16, 0);
#endif
}

void        fSET_PH_TIME_SAMPLING (sData *str_Receiv, uint16_t Pos)
{
#ifdef USING_APP_OXYGEN
    uint32_t TempU32 = 0;
    if( str_Receiv->Data_a8[0] >= '0' && str_Receiv->Data_a8[0] <= '9')
    {
        ...
        if(TempU32 <=PH_TIME_CONTROL_MAX && TempU32 >=PH_TIME_CONTROL_MIN)
        {
            Save_pH_TimeControl(sParamCtrlPH.pH_TimePump, TempU32);
            DCU_Respond(PortConfig, (uint8_t*)"OK", 2, 0);
        }
        else
        {
...
void        fGET_PH_CHOOSE_OPTION (sData *str_Receiv, uint16_t Pos)
{
#ifdef USING_APP_OXYGEN
    if(sParamCtrlPH.ChooseOptionPH == _ONE_SENSOR_PH)
    {
        uint8_t aTemp[25] = "pH_Choose: _ONE_SENSOR_PH";   
        sData StrResp = {&aTemp[0], 25}; 
        DCU_Respond(PortConfig, StrResp.Data_a8, StrResp.Length_u16, 0);
    }
    else
    {
        uint8_t aTemp[26] = "pH_Choose: _NONE_SENSOR_PH";   
        sData StrResp = {&aTemp[0], 26}; 
        DCU_Respond(PortConfig, StrResp.Data_a8, StrResp.Length_u16, 0);
    }
#endif
}

void        fSET_PH_CHOOSE_OPTION (sData *str_Receiv, uint16_t Pos)
{
#ifdef USING_APP_OXYGEN
    uint32_t TempU32 = 0;
    if( str_Receiv->Data_a8[0] >= '0' && str_Receiv->Data_a8[0] <= '9')
    {
        ...
        TempU32 = Convert_String_To_Dec(str_Receiv->Data_a8 , length);
        if(TempU32 == _NONE_SENSOR_PH || TempU32 == _ONE_SENSOR_PH)
        {
            Save_pH_ChooseOption(TempU32);
            DCU_Respond(PortConfig, (uint8_t*)"OK", 2, 0);
        }
        else
        {
...
{
#ifdef USING_APP_OXYGEN
    uint8_t aTemp[80] = "Oxy_Measure:Temp=";   //11 ki tu dau tien
    uint16_t length = 17;
    ...
    Convert_Point_Int_To_String_Scale (aTemp, &length, (int)(sParamMeasure.Salinity), 0xFE);
    Insert_String_To_String(aTemp, &length, (uint8_t*)"ppt,pH=",0 , 7);
    
    Convert_Point_Int_To_String_Scale (aTemp, &length, (int)(sParamCtrlPH.pH_Measure), 0xFE);
...
void        fGET_CYCLE_SLAVE_CTRL (sData *str_Receiv, uint16_t Pos)
{
    ...
    Convert_Point_Int_To_String_Scale (aTemp, &length, (int)(sTimeSlave.FreeCtrl), 0xFF);
...
void        fSEND_MOTOR_FAIL (sData *str_Receiv, uint16_t Pos)
{
#ifdef USING_APP_OXYGEN
...
void        fGET_NUMBER_MOTOR (sData *str_Receiv, uint16_t Pos)
{
#ifdef USING_APP_OXYGEN
    uint8_t aTemp[20] = "NumberMotor:";   //13 ki tu dau tien
    sData StrResp = {&aTemp[0], 12}; 

    Convert_Uint64_To_StringDec (&StrResp, (uint64_t) (Number_Motor_Slave), 0);

	DCU_Respond(PortConfig, StrResp.Data_a8, StrResp.Length_u16, 0);
#endif
}

void        fSET_NUMBER_MOTOR (sData *str_Receiv, uint16_t Pos)
{
#ifdef USING_APP_OXYGEN
    uint32_t TempU32 = 0;
    if( str_Receiv->Data_a8[0] >= '0' && str_Receiv->Data_a8[0] <= '9')
    {
        ...
        TempU32 = Convert_String_To_Dec(str_Receiv->Data_a8 , length);
        if(TempU32 <= NUMBER_SLAVE_MOTOR_MAX)
        {
            Save_NumberMotorSlave(TempU32);
            DCU_Respond(PortConfig, (uint8_t*)"OK", 2, 0);
        }
        else
        {
...
void        fGET_TIME_RUN_SAFETY (sData *str_Receiv, uint16_t Pos)
{
#ifdef USING_APP_OXYGEN
    uint8_t aTemp[50] = "TimeRunSafety:";   //13 ki tu dau tien
    sData StrResp = {&aTemp[0], 14}; 

    Convert_Uint64_To_StringDec (&StrResp, (uint64_t) (sTimeSafety.TimeRun), 0);

	DCU_Respond(PortConfig, StrResp.Data_a8, StrResp.Length_u16, 0);
#endif
}
void        fSET_TIME_RUN_SAFETY (sData *str_Receiv, uint16_t Pos)
{
#ifdef USING_APP_OXYGEN
    uint32_t TempU32 = 0;
    if( str_Receiv->Data_a8[0] >= '0' && str_Receiv->Data_a8[0] <= '9')
    {
        ...
        TempU32 = Convert_String_To_Dec(str_Receiv->Data_a8 , length);
        if(TempU32 <=TIME_SAFETY_MAX && TempU32 >=TIME_SAFETY_MIN)
        {
            Save_TimeSafety(TempU32, sTimeSafety.TimeSampling);
            DCU_Respond(PortConfig, (uint8_t*)"OK", 2, 0);
        }
        else
        {
...
void        fGET_TIME_SAMPLING_SAFETY (sData *str_Receiv, uint16_t Pos)
{
#ifdef USING_APP_OXYGEN
    uint8_t aTemp[50] = "TimeSamplingSafety:";   //13 ki tu dau tien
    sData StrResp = {&aTemp[0], 19}; 

    Convert_Uint64_To_StringDec (&StrResp, (uint64_t) (sTimeSafety.TimeSampling), 0);

	DCU_Respond(PortConfig, StrResp.Data_a8, StrResp.Length_u16, 0);
#endif
}

void        fSET_TIME_SAMPLING_SAFETY (sData *str_Receiv, uint16_t Pos)
{
#ifdef USING_APP_OXYGEN
    uint32_t TempU32 = 0;
    if( str_Receiv->Data_a8[0] >= '0' && str_Receiv->Data_a8[0] <= '9')
    {
        ...
        if(TempU32 <=TIME_SAFETY_MAX && TempU32 >=TIME_SAFETY_MIN)
        {
            Save_TimeSafety( sTimeSafety.TimeRun, TempU32);
            DCU_Respond(PortConfig, (uint8_t*)"OK", 2, 0);
        }
        else
        {
