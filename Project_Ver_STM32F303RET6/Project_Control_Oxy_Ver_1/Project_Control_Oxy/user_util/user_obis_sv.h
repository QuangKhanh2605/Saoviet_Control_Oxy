...
#define OBIS_ENVI_SET_PH_UPPER      0xB7
#define OBIS_ENVI_SET_PH_LOWER      0xB8

#define OBIS_WARNING_OXY_LOWER      0xD1
#define OBIS_WARNING_POWER          0xD3
#define OBIS_WARNING_CONNECT_SENSOR 0xD4

#define OBIS_WARNING_PH_LOWER       0xD6
#define OBIS_WARNING_CONNECT_PH     0xD9

#define OBIS_WARNING_PUMP           0xD2
...
#define OBIS_STATE_PUMP_PH          0x94
