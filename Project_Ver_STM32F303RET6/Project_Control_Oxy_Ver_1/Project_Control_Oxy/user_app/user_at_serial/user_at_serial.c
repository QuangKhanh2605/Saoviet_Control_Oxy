...
//			id ENUM				  kind process			     str Received
        ...
        {_GET_PH_STEP_WARNING,  fGET_PH_STEP_WARNING,       {(uint8_t*)"at+phwarning?",13}},
        {_SET_PH_STEP_WARNING,  fSET_PH_STEP_WARNING,       {(uint8_t*)"at+phwarning=",13}},
        
        {_GET_PH_TIME_PUMP,     fGET_PH_TIME_PUMP,          {(uint8_t*)"at+phtimepump?",14}},
        {_SET_PH_TIME_PUMP,     fSET_PH_TIME_PUMP,          {(uint8_t*)"at+phtimepump=",14}},
        
        {_GET_PH_TIME_SAMPLING, fGET_PH_TIME_SAMPLING,      {(uint8_t*)"at+phtimesampling?",18}},
        {_SET_PH_TIME_SAMPLING, fSET_PH_TIME_SAMPLING,      {(uint8_t*)"at+phtimesampling=",18}},
        
        {_GET_PH_CHOOSE_OPTION, fGET_PH_CHOOSE_OPTION,      {(uint8_t*)"at+phoption?",12}},
        {_SET_PH_CHOOSE_OPTION, fSET_PH_CHOOSE_OPTION,      {(uint8_t*)"at+phoption=",12}},
