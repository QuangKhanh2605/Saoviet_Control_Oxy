...
uint8_t     aIP_SERVER_BACKUP[MAX_IP_LENGTH] = "117.6.163.177";  //Default: mqtt.saovietgroup.com.vn
uint8_t     aPORT_SERVER_BACKUP[MAX_PORT_LENGTH] = "1883";       //Default: 1883
...
Struct_Sim_Information	sSimInfor = 
{
    ...
    .sServer.sIPBackUp            = {&aIP_SERVER_BACKUP[0], 13},
