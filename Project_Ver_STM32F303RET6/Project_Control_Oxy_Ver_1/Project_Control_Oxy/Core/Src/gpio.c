...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, SIM_RESET_Pin|SIM_PWR_KEY_Pin|SIM_DTR_Pin|MCU_RL7_Pin
                          |MCU_RL1_Pin|RS485_TXDE_S_Pin|MCU_LCD_D1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, MCU_RL4_Pin|MCU_RL5_Pin|MCU_RL6_Pin|RS485_TXDE_Pin
                          |MCU_LCD_D6_Pin|MCU_LCD_D7_Pin|MCU_LCD_PSB_Pin|MCU_LCD_RST_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PAPin PAPin PAPin PAPin
                           PAPin PAPin PAPin */
  GPIO_InitStruct.Pin = SIM_RESET_Pin|SIM_PWR_KEY_Pin|SIM_DTR_Pin|MCU_RL7_Pin
                          |MCU_RL1_Pin|RS485_TXDE_S_Pin|MCU_LCD_D1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  GPIO_InitStruct.Pin = MCU_RL4_Pin|MCU_RL5_Pin|MCU_RL6_Pin|RS485_TXDE_Pin
                          |MCU_LCD_D6_Pin|MCU_LCD_D7_Pin|MCU_LCD_PSB_Pin|MCU_LCD_RST_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : PBPin PBPin PBPin PBPin */
  GPIO_InitStruct.Pin = MCU_SW_MAN_Pin|MCU_SW_AUTO_Pin|BT_EXIT_Pin|BT_DOWN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
