...
#define Speaker_GPIO_Port GPIOF
#define BT_ENTER_Pin GPIO_PIN_0
#define BT_ENTER_GPIO_Port GPIOC
#define ON_OFF_Vout_Pin GPIO_PIN_1
...
#define MCU_RL7_Pin GPIO_PIN_6
#define MCU_RL7_GPIO_Port GPIOA
#define MCU_RL1_Pin GPIO_PIN_7
#define MCU_RL1_GPIO_Port GPIOA
#define MCU_RL2_Pin GPIO_PIN_4
#define MCU_RL2_GPIO_Port GPIOC
#define MCU_RL3_Pin GPIO_PIN_5
#define MCU_RL3_GPIO_Port GPIOC
#define MCU_RL4_Pin GPIO_PIN_0
#define MCU_RL4_GPIO_Port GPIOB
#define MCU_RL5_Pin GPIO_PIN_1
#define MCU_RL5_GPIO_Port GPIOB
#define MCU_RL6_Pin GPIO_PIN_2
#define MCU_RL6_GPIO_Port GPIOB
#define RS485_TXDE_Pin GPIO_PIN_12
#define RS485_TXDE_GPIO_Port GPIOB
#define MCU_SW_MAN_Pin GPIO_PIN_13
#define MCU_SW_MAN_GPIO_Port GPIOB
#define MCU_SW_AUTO_Pin GPIO_PIN_14
...
#define RS485_TXDE_S_Pin GPIO_PIN_8
#define RS485_TXDE_S_GPIO_Port GPIOA
#define MCU_LCD_D1_Pin GPIO_PIN_15
#define MCU_LCD_D1_GPIO_Port GPIOA
#define MCU_LCD_D2_Pin GPIO_PIN_10
#define MCU_LCD_D2_GPIO_Port GPIOC
#define MCU_LCD_D3_Pin GPIO_PIN_11
#define MCU_LCD_D3_GPIO_Port GPIOC
