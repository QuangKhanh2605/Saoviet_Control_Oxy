...
#define DEFAULT_PRESSURE_CONSTANT   6
#define PRESSURE_CONSTANT_MAX       20
#define PRESSURE_CONSTANT_MIN       2

#define NUMBER_SAMPLING_AVG_ADC     5000

#define PRESSURE_UPPER_DEFAULT      50
...
typedef struct
{
    ...
    uint32_t WaitSamplingPressureGetTick_Ms;
